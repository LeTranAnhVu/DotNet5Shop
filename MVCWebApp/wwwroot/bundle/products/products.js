...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"run\": () => (/* binding */ run)\n/* harmony export */ });\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ \"jquery\");\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _helpers_handleCheckboxChange__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../helpers/handleCheckboxChange */ \"./src/helpers/handleCheckboxChange.js\");\n/* harmony import */ var _helpers_handleNumberInputChange__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../helpers/handleNumberInputChange */ \"./src/helpers/handleNumberInputChange.js\");\n/* harmony import */ var _helpers_queryParam__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../helpers/queryParam */ \"./src/helpers/queryParam.js\");\n/* harmony import */ var _helpers_loadCheckboxState__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../helpers/loadCheckboxState */ \"./src/helpers/loadCheckboxState.js\");\n/* harmony import */ var _helpers_loadInputState__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../helpers/loadInputState */ \"./src/helpers/loadInputState.js\");\n/* harmony import */ var _shared_searchQueryHandler__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../shared/searchQueryHandler */ \"./src/shared/searchQueryHandler.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\n\n\n\n\n\n\n\nfunction run() {\n  var filterHandler = new SideFilterHandler();\n  filterHandler.run();\n  var productViewSwitch = new ProductViewSwitch();\n  productViewSwitch.run();\n  var searchQueryHandler = new _shared_searchQueryHandler__WEBPACK_IMPORTED_MODULE_6__.default();\n  searchQueryHandler.run();\n}\n\nvar ProductViewSwitch = /*#__PURE__*/function () {\n  function ProductViewSwitch() {\n    _classCallCheck(this, ProductViewSwitch);\n\n    _defineProperty(this, \"$grid\", jquery__WEBPACK_IMPORTED_MODULE_0___default()('.product-view-switch .grid-filter'));\n\n    _defineProperty(this, \"$list\", jquery__WEBPACK_IMPORTED_MODULE_0___default()('.product-view-switch .list-filter'));\n  }\n\n  _createClass(ProductViewSwitch, [{\n    key: \"run\",\n    value: function run() {\n      this.listenViewChange(this.$grid);\n      this.listenViewChange(this.$list);\n      this.loadState();\n    }\n  }, {\n    key: \"loadState\",\n    value: function loadState() {\n      var _parseCurrentParam = (0,_helpers_queryParam__WEBPACK_IMPORTED_MODULE_3__.parseCurrentParam)(),\n          productViewType = _parseCurrentParam.productViewType;\n\n      if (productViewType === 'list') {\n        this.$list.addClass('active');\n        this.$grid.removeClass('active');\n      } else {\n        this.$grid.addClass('active');\n        this.$list.removeClass('active');\n      }\n    }\n  }, {\n    key: \"listenViewChange\",\n    value: function listenViewChange($element) {\n      $element.click(function () {\n        var value = $element.hasClass('list-filter') ? 'list' : 'grid';\n        var queryObj = (0,_helpers_queryParam__WEBPACK_IMPORTED_MODULE_3__.parseCurrentParam)();\n        queryObj.productViewType = value;\n        var queryStr = (0,_helpers_queryParam__WEBPACK_IMPORTED_MODULE_3__.stringifyQuery)(queryObj);\n        (0,_helpers_queryParam__WEBPACK_IMPORTED_MODULE_3__.updateUrl)(queryStr);\n        window.location.href = window.location.href;\n      });\n    }\n  }]);\n\n  return ProductViewSwitch;\n}(); // Side Filter\n\n\nvar SideFilterHandler = /*#__PURE__*/function () {\n  function SideFilterHandler() {\n    _classCallCheck(this, SideFilterHandler);\n\n    _defineProperty(this, \"brandSet\", new Set());\n\n    _defineProperty(this, \"categorySet\", new Set());\n\n    _defineProperty(this, \"minValue\", {\n      value: undefined\n    });\n\n    _defineProperty(this, \"maxValue\", {\n      value: undefined\n    });\n\n    _defineProperty(this, \"$form\", jquery__WEBPACK_IMPORTED_MODULE_0___default()('#side-filters-form'));\n\n    _defineProperty(this, \"$applyBtn\", jquery__WEBPACK_IMPORTED_MODULE_0___default()('.side-filters .js-btn-submit'));\n\n    _defineProperty(this, \"$brandFilterCheckboxes\", jquery__WEBPACK_IMPORTED_MODULE_0___default()('.brand-filters input[type=checkbox]'));\n\n    _defineProperty(this, \"$categoryFilterCheckboxes\", jquery__WEBPACK_IMPORTED_MODULE_0___default()('.category-filters input[type=checkbox]'));\n\n    _defineProperty(this, \"$minInput\", jquery__WEBPACK_IMPORTED_MODULE_0___default()('.min-max-filters input#min-price'));\n\n    _defineProperty(this, \"$maxInput\", jquery__WEBPACK_IMPORTED_MODULE_0___default()('.min-max-filters input#max-price'));\n  }\n\n  _createClass(SideFilterHandler, [{\n    key: \"run\",\n    value: function run() {\n      this.listenToFilters();\n      this.updateTheFilters();\n      this.listenToSubmitBtn();\n    }\n  }, {\n    key: \"updateTheFilters\",\n    value: function updateTheFilters() {\n      // Get query param\n      var params = (0,_helpers_queryParam__WEBPACK_IMPORTED_MODULE_3__.parseCurrentParam)();\n      var brands = params.brands,\n          categories = params.categories,\n          min = params.min,\n          max = params.max;\n      min = isNaN(Number(min)) ? undefined : Number(min);\n      max = isNaN(Number(max)) ? undefined : Number(max);\n      (0,_helpers_loadCheckboxState__WEBPACK_IMPORTED_MODULE_4__.loadCheckboxState)(this.$brandFilterCheckboxes, brands);\n      (0,_helpers_loadCheckboxState__WEBPACK_IMPORTED_MODULE_4__.loadCheckboxState)(this.$categoryFilterCheckboxes, categories);\n      (0,_helpers_loadInputState__WEBPACK_IMPORTED_MODULE_5__.loadInputState)(this.$minInput, min);\n      (0,_helpers_loadInputState__WEBPACK_IMPORTED_MODULE_5__.loadInputState)(this.$maxInput, max);\n    }\n  }, {\n    key: \"listenToSubmitBtn\",\n    value: function listenToSubmitBtn() {\n      var _this = this;\n\n      this.$applyBtn.click(function (event) {\n        event.preventDefault();\n        var queryObj = (0,_helpers_queryParam__WEBPACK_IMPORTED_MODULE_3__.parseCurrentParam)();\n        queryObj.brands = Array.from(_this.brandSet);\n        queryObj.categories = Array.from(_this.categorySet);\n        queryObj.min = _this.minValue.value;\n        queryObj.max = _this.maxValue.value;\n        var queryStr = (0,_helpers_queryParam__WEBPACK_IMPORTED_MODULE_3__.stringifyQuery)(queryObj);\n        (0,_helpers_queryParam__WEBPACK_IMPORTED_MODULE_3__.updateUrl)(queryStr);\n        window.location.href = window.location.href;\n      });\n    }\n  }, {\n    key: \"listenToFilters\",\n    value: function listenToFilters() {\n      (0,_helpers_handleCheckboxChange__WEBPACK_IMPORTED_MODULE_1__.handleCheckboxChange)(this.$brandFilterCheckboxes, this.brandSet);\n      (0,_helpers_handleCheckboxChange__WEBPACK_IMPORTED_MODULE_1__.handleCheckboxChange)(this.$categoryFilterCheckboxes, this.categorySet);\n      (0,_helpers_handleNumberInputChange__WEBPACK_IMPORTED_MODULE_2__.handleNumberInputChange)(this.$minInput, this.minValue);\n      (0,_helpers_handleNumberInputChange__WEBPACK_IMPORTED_MODULE_2__.handleNumberInputChange)(this.$maxInput, this.maxValue);\n    }\n  }]);\n\n  return SideFilterHandler;\n}();\n\n//# sourceURL=webpack://mvcwebapp/./src/views/products.js?");
